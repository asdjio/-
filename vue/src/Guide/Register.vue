<template>
  <div style="width: 100vw;height: 100vh;" class="clazz_nac">
    <div class="login-box">
      <h2>注册账号</h2>
      <form>
        <div class="user-box">
        ...
        <div class="user-box">
          <input type="phone" name="" required="" v-model="phone">
          <label>联系方式</label>
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
export default {
  ...
  methods: {
    handleSubmit() {
      if (this.number===0||this.username===''||this.password===''||this.phone===''){
        Toast.fail('请完整输入')
        return
      }
...
.clazz_nac {
  ...
  background-size: cover; /* 覆盖整个元素，保持比例裁剪 */
}
